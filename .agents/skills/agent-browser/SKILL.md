...
| [references/common-patterns.md](references/common-patterns.md)       | Form submission, iframes, data extraction, iOS simulator  |
| [references/security.md](references/security.md)                     | Content boundaries, domain allowlist, action policy       |
| [references/advanced-usage.md](references/advanced-usage.md)         | Diffing, timeouts, JS eval, config, engine selection      |
